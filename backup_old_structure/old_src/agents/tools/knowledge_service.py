...
class KnowledgeService:
    ...
    PROMPT_TEMPLATES = {
        ...
        "kp_context": (
            "请从知识库中检索相关内容，并将其分类整理，以便KP使用。"
            "请严格按照以下三个Markdown标题输出内容（如果某项无内容，请写'无'）：\n"
            "# [Lore]\n(在此处填写相关的世界观设定、历史背景、怪物图鉴等静态知识)\n\n"
            "# [Memory]\n(在此处填写相关的近期剧情、玩家之前的行动、对话记录等动态经历)\n\n"
            "# [Secret]\n(在此处填写相关的隐藏秘密、幕后真相、不可见之物等，仅供KP参考)\n"
        ),
    }
